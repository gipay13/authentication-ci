  ...
  <div class="wrapper">
				...
				<li class="nav-item dropdown">
					<a class="nav-link" data-toggle="dropdown" href="#">
						<div class="user-panel">
							<div class="image">
								<img src="<?= base_url('uploads/image_profile/'.$user->image)?>" class="img-circle elevation-2" alt="User Image">
							</div>
						</div>
					</a>
    ...
    <div class="sidebar">
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?= base_url('users') ?>" class="d-block"><?= $user->name ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
		...
		<footer class="main-footer">
			<strong>Copyright &copy; 2021 <a href="">Projek</a>.</strong>
			All rights reserved.
		</footer>
